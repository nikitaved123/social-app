...
### 3. 🌐 Демо (фронтенд)
https://social-app-eight-beige.vercel.app

**Важно:** Демо показывает только интерфейс. Бэкенд не развёрнут, поэтому данные не загружаются. Полная работа проекта — при локальном запуске.
---
